            ...
            <div className='max-w-[1140px] mx-auto'>
                <div className='flex flex-col justify-center'>
                    ...
                    <div className='flex items-center justify-between flex-col xl:flex-row'>
                        <div className='flex order-2 xl:order-1 flex-col max-w-[760px] md:text-[18px] ph:text-[14px] leading-[24px] text-timerText xl:gap-y-6 gap-y-1 xl:p-[40px] p-[16px] ph:p-[12px] frame-with-triangle'>
                            <p>
